...
df_1 = pd.read_csv('EStateSum_train_0.65.csv', sep = ',', dtype={'name': str})
...
df_2 = pd.read_csv('EStateSum_test.csv', sep = ',', dtype={'name': str})
...
df.to_csv('rf_EstateSum_cv_results_.csv')
if rank == 0:
