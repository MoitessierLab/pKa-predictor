...
df_1 = pd.read_csv('2D_train_0.65.csv', sep=',', dtype={'name': str})
df_1 = df_1.dropna(axis=1)
X_train = df_1.drop(['pKa', 'name'], axis=1)
Y_train = df_1.pKa
#print(X_train.shape, Y_train.shape)

df_2 = pd.read_csv('2D_test.csv', sep=',', dtype={'name': str})
df_2 = df_2.dropna(axis=1)
X_test = df_2[X_train.columns]  # Drop the same columns as in X_train
Y_test = df_2.pKa
...
bayes_cv_tuner = BayesSearchCV(estimator = RandomForestRegressor(),
...
df.to_csv('rf_2D_cv_results_.csv')
if rank == 0:
