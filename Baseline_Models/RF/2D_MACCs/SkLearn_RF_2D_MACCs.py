...
df_1 = pd.read_csv('2D_MACCs_train_0.65.csv', sep = ',', dtype={'name': str})
...
df_2 = pd.read_csv('2D_MACCs_test.csv', sep = ',', dtype={'name': str})
...
df.to_csv('rf_2D_MACCs_cv_results_.csv')
if rank == 0:
