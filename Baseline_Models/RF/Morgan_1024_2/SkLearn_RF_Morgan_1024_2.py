...
df_1 = pd.read_csv('Morgan_1024_2_train_0.65.csv', sep = ',', dtype={'name': str})
...
df_2 = pd.read_csv('Morgan_1024_2_test.csv', sep = ',', dtype={'name': str})
...
df.to_csv('rf_Morgan_1024_2_cv_results_.csv')
if rank == 0:
...
plt.savefig('Morgan_1024_2_RF.pdf')
