...
def argsParser():
    ...
    parser.add_argument("--mask_size", help="dimension of local environment", type=int, default=3)
    parser.add_argument("--n_FC_layers", help="number of FC layers", type=int, default=2)
    parser.add_argument("--model_dense_neurons", help="dimension of FC layers", type=int, default=512)
    ...
    parser.add_argument("--train_source_1", help="train source", type=str, default='None')
    parser.add_argument("--train_source_2", help="train source", type=str, default='None')
    parser.add_argument("--train_source_3", help="train source", type=str, default='None')
    parser.add_argument("--train_source_4", help="train source", type=str, default='None')
    parser.add_argument("--train_source_5", help="train source", type=str, default='None')
    parser.add_argument("--train_source_6", help="train source", type=str, default='None')
    parser.add_argument("--train_source_7", help="train source", type=str, default='None')
    parser.add_argument("--train_source_8", help="train source", type=str, default='None')
    parser.add_argument("--train_source_9", help="train source", type=str, default='None')
    parser.add_argument("--train_source_10", help="train source", type=str, default='None')
    parser.add_argument("--test_pickled", help="test pickled", type=str, default='pickled_data/test_pickled.pkl')
    parser.add_argument("--test_source_1", help="test source", type=str, default='None')
    parser.add_argument("--test_source_2", help="test source", type=str, default='None')
    parser.add_argument("--test_source_3", help="test source", type=str, default='None')
    parser.add_argument("--test_source_4", help="test source", type=str, default='None')
    parser.add_argument("--test_source_5", help="test source", type=str, default='None')
    ...
    if args.mode == 'train':
        ...
        print('| --train_source_1 (data source):                                    %-55s |' % args.train_source_1)
        print('| --train_source_2 (data source):                                    %-55s |' % args.train_source_2)
        print('| --train_source_3 (data source):                                    %-55s |' % args.train_source_3)
        print('| --train_source_4 (data source):                                    %-55s |' % args.train_source_4)
        print('| --train_source_5 (data source):                                    %-55s |' % args.train_source_5)
        print('| --train_source_6 (data source):                                    %-55s |' % args.train_source_6)
        print('| --train_source_7 (data source):                                    %-55s |' % args.train_source_7)
        print('| --train_source_8 (data source):                                    %-55s |' % args.train_source_8)
        print('| --train_source_9 (data source):                                    %-55s |' % args.train_source_9)
        print('| --train_source_10 (data source):                                   %-55s |' % args.train_source_10)
        print('| --test_data (data of the testing set):                             %-55s |' % args.test_data)
        print('| --test_source_1 (data source):                                     %-55s |' % args.test_source_1)
        print('| --test_source_2 (data source):                                     %-55s |' % args.test_source_2)
        print('| --test_source_3 (data source):                                     %-55s |' % args.test_source_3)
        print('| --test_source_4 (data source):                                     %-55s |' % args.test_source_4)
        print('| --test_source_5 (data source):                                     %-55s |' % args.test_source_5)
    ...
    if args.mode == 'test' or args.mode == 'infer' or args.mode == 'pH':
        ...
        print('| --model_dir (directory where model is):                            %-55s |' % args.save_dir)
        print('| --model_name (model file name):                                    %-55s |' % args.model_name)
