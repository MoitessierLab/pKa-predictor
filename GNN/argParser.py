...
def argsParser():
    ...
    #parser.add_argument("--node_embedding_size", help="dimension of GNN node embedding", type=int, default=128)
    ...
    parser.add_argument("--carbons_included", help="test source", type=str2bool, default=True)
    ...
    if args.mode == 'train' or args.mode == 'hyperopt':
        ...
        #print('| --node_embedding_size (dimension of embedding for nodes):          %-55.0f |' % args.node_embedding_size)
